...
const BarraSuperior = () => {
  ...
  const handleOptionClick = (e) => {
    ...
    return (
      ...
      >
        <li><a className="dropdown-item" href="/AlmacenamientoInformacionCliente">Almacenamiento Informacion Cliente</a></li>
        <li><a className="dropdown-item" href="/AgregarInformacionCliente">Agregar Informacion Cliente</a></li>
